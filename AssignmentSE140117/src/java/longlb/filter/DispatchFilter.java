...
public class DispatchFilter implements Filter {
	...
	try {
	    ...
	    if (isNotLogin) {
		List<String> authFunctions = (List<String>) context.getAttribute("AUTH_FUNCTIONS");
		for (String function : authFunctions) {
		    if (resource.equals(function)) {
			isRedirected = true;
